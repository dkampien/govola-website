...
export function HeroExperimental({ pathLengths, scrollRef }: HeroExperimentalProps) {
  ...
  return (
    <section id="hero" className="w-full relative" ref={scrollRef}>
      <div className="relative flex flex-col items-center w-full px-6">
        <div className="absolute inset-0">
          <div className="absolute inset-0 -z-10 h-[600px] md:h-[800px] w-full [background:radial-gradient(125%_125%_at_50%_10%,var(--background)_40%,#46c5e2_100%)] rounded-b-xl"></div>
        </div>
        <div className="relative z-10 pt-32 max-w-3xl mx-auto h-full w-full flex flex-col gap-10 items-center justify-center">
          ...
          <div className="flex items-center justify-center">
            <Link
              ...
              className="bg-[#ffc52a] h-11 flex items-center justify-center text-sm font-medium tracking-wide rounded-full text-black px-6 shadow-md hover:bg-[#ffc52a]/90 transition-all ease-out active:scale-95"
            >
